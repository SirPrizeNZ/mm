...
board = Image.open(HERE / "source" / "current-live-board.png").convert("RGB")

cover = Image.new("RGB", (1920, 1080), "#111116")
d = ImageDraw.Draw(cover)
panel(d, (74, 76, 1846, 1004), "#1b1a20", 42, "#3b3940", 3)
d.text((142, 155), "SCALE", font=font(100, True), fill="#ffe500")
d.text((142, 262), "MINIATURES", font=font(100, True), fill="#ffe500")
...
d.text((177, 592), "PLAY IN FIGJAM", font=font(42, True), fill="#141216")
...
board_card = board.crop((560, 353, 1200, 850))
...
scaled = board_card.resize((1152, 895), Image.Resampling.LANCZOS)
board_image.paste(scaled, (384, 250))
